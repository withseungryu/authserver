  ...
  <div class="container">
    ...
    <form id="signup">
      ...
      <div class="inputs">
        ...
        <input type="email" v-model="email" placeholder="e-mail" autofocus />
        ...
        <a id="submit" href="#" v-on:click ="pushSignUp()">SIGN UP FOR INVITE NOW</a>
...
import {LoginForm} from "~/store/loginStore";
...
export default class SignUp extends Vue {
  ...
  pushSignUp(){
    ...
    this.$store.dispatch('loginStore/postSignUp', this.loginForm);
